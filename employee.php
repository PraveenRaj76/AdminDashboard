<?php include ('header.php'); ?>
        ...
        <div class="page-title">
            <div class="title_left">
                <h3>
					<small><a href="admin_home.php">Home</a> /</small> STE's
                </h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
							...
							<button class="btn btn-danger pull-right"><i class="fa fa-print"></i> Print STE's List</button>
							</a>
							<br />
							<br />
                    <div class="x_title">
                        <h2><i class="fa fa-users"></i> STE's Information</h2>
                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <li>
                                <a href="import_employees.php" style="background:none;">

...
<button type="submit" id="print" onclick="printPage()" style=" position: absolute; right: 20;">Print</button>
            <br />
            <p style = "margin-left:30px; margin-top:50px; font-size:14pt; font-weight:bold;">Employees Barcode</p>
        <div align="right">
		...
		<br/>
<?php
							$result= mysqli_query($con,"select * from employee order by id DESC") or die (mysqli_error());
?>
						<table class="table">
						  <thead>
								<tr>
